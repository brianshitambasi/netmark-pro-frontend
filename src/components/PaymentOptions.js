  ...
  return (
    <Modal show={show} onHide={onHide} size="lg" centered>
      ...
      <Modal.Body>
        ...
        {isFullyPaid && <Alert variant="success" className="text-center"><FaCheckCircle className="me-2" /><strong>✅ FULLY PAID!</strong> This prospect has completed their package payment.</Alert>}
